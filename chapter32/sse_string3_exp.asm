...
; print.
	...
	call	printf
;-------------------------------------------------------------
; now print the result of the comparsion.
	pop	rax
	mov	rdi,fmt2
	cmp	rax,0
	je	eql2
...
pstrcmp:
	...
	xor	rbx,rbx
	mov	rax,rdx		; rax contains length 1st string.
	mov	rdx,rcx		; rdx contains length 2st string.
...
.differ:
	mov	rax,rbx,
	add	rax,rcx		; rcx contains the difference position.
